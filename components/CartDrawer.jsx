            ...
            {!isEmpty && (
              <div className="border-t border-gold/20 px-5 py-5 space-y-3">
                ...
                <a
                  ...
                  onClick={close}
                  className="flex items-center justify-center gap-2.5 bg-burgundy text-white text-[0.67rem] tracking-[0.18em] uppercase px-6 py-3.5 w-full hover:opacity-90 transition-opacity"
                >
